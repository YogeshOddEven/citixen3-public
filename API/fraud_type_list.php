...
{*/
	...
	//$condition=" cid='".$cid."' ";
	//$condition="";
	$fraud_type_list=get_ConditionalDetailsFromTable($table_name,$is_stat_chk="0",$file_field="",$condition,$is_multiple,$select_fields,$page,$limit,"","","1");
	...
	if($fraud_type_list!="")
	{
		...
		$data['fraud_type_list']=$fraud_type_list;
