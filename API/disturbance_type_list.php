...
{*/
	...
	//$condition=" cid='".$cid."' ";
	//$condition="";
	$disturbance_type_list=get_ConditionalDetailsFromTable($table_name,$is_stat_chk="0",$file_field="",$condition,$is_multiple,$select_fields,$page,$limit,"","","1");

	//$disturbance_type_list="";
	if($disturbance_type_list!="")
	{
			
		
		$data['disturbance_type_list']=$disturbance_type_list;
	...
	}else
	{
		$data['total_records']=$total_records;
		$data['total_pages']=$total_pages;
		$data['disturbance_type_list']=null;
		if($user_language=="" || $user_language=="en" || $user_language=="EN" || $user_language=="ENG")
		{
