...
{*/
	...
	//$condition=" cid='".$cid."' ";
	//$condition="";
	$vandalism_type_list=get_ConditionalDetailsFromTable($table_name,$is_stat_chk="0",$file_field="",$condition,$is_multiple,$select_fields,$page,$limit,"","","1");

	//$vandalism_type_list="";
	if($vandalism_type_list!="")
	{
			
		
		$data['vandalism_type_list']=$vandalism_type_list;
