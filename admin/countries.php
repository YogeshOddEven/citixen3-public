<div class="page-header mt-0 shadow p-3">
	<ol class="breadcrumb mb-sm-0">
		...
		<li class="breadcrumb-item active" aria-current="page">Country Data</li>
	</ol>
</div>
<div class="row">
   	<div class="col-md-12">
            	...
            	<div class="table-responsive">
					<table id="datatable" class="table card-table table-vcenter text-nowrap align-items-center">
						...
						<tbody>
							<?php
							 	$i = 1;
								$query2 = "select * from cz_countries order by id";
													  ...
													  <div class="modal-content-wrap">
														   <div class="modal-content">
																...
																<div class="modal-footer">
																	<a href="process/delete_country.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger btn-xs">Delete</a>
		...
		<div class="card shadow">
			...
			<div class="card-body">
                ...
                <?php
					...
					{
						$sel = "select * from cz_countries where id='".$_REQUEST['id']."'";
						$qry = mysqli_query($conn,$sel);
						$fet = mysqli_fetch_array($qry);
					}
				?>
                <form class="form-horizontal validate-form" data-err_msg_ele="help"  method="post" action="process/action_country.php" enctype="multipart/form-data">
                <div class="col-md-12">
                   <div class="form-group">
                        <label class="col-md-3 control-label">Country Name</label>    
                        <div class="col-md-6">
	                        <input type="text" class="form-control"  data-is_validate="1" placeholder="Country Name" name="name" id="name" <?php if(isset($_REQUEST['id'])){ echo "value='".$fet['name']."'"; }?>>
