...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2021 at 12:05 PM
...
CREATE TABLE `pns_customers` (
  ...
  `account_close_remarks` text DEFAULT NULL,
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'Administrator', 'Pack N Send', 'Admin', '9227387054', '', '', '0', '_1613583079.png', '1', '');
...
(2887, 'Super Admin', 'dashboard', '1'),
(2888, 'Super Admin', 'view_stats', '1'),
(2889, 'Super Admin', 'view_decent', '1'),
(2890, 'Super Admin', 'rider', '1'),
(2891, 'Super Admin', 'add_rider', '1'),
(2892, 'Super Admin', 'update_rider', '1'),
(2893, 'Super Admin', 'remove_rider', '1'),
(2894, 'Super Admin', 'view_rider', '1'),
(2895, 'Super Admin', 'export_rider', '1'),
(2896, 'Super Admin', 'driver', '1'),
(2897, 'Super Admin', 'add_driver', '1'),
(2898, 'Super Admin', 'update_driver', '1'),
(2899, 'Super Admin', 'remove_driver', '1'),
(2900, 'Super Admin', 'view_driver', '1'),
(2901, 'Super Admin', 'verify_driver', '1'),
(2902, 'Super Admin', 'export_driver', '1'),
(2903, 'Super Admin', 'ride', '1'),
(2904, 'Super Admin', 'add_ride', '1'),
(2905, 'Super Admin', 'update_ride', '1'),
(2906, 'Super Admin', 'remove_ride', '1'),
(2907, 'Super Admin', 'view_ride', '1'),
(2908, 'Super Admin', 'export_ride', '1'),
(2909, 'Super Admin', 'vehicle', '1'),
(2910, 'Super Admin', 'add_vehicle', '1'),
(2911, 'Super Admin', 'update_vehicle', '1'),
(2912, 'Super Admin', 'remove_vehicle', '1'),
(2913, 'Super Admin', 'view_vehicle', '1'),
(2914, 'Super Admin', 'export_vehicle', '1'),
(2915, 'Super Admin', 'ambulance', '1'),
(2916, 'Super Admin', 'add_ambulance', '1'),
(2917, 'Super Admin', 'update_ambulance', '1'),
(2918, 'Super Admin', 'remove_ambulance', '1'),
(2919, 'Super Admin', 'view_ambulance', '1'),
(2920, 'Super Admin', 'export_ambulance', '1'),
(2921, 'Super Admin', 'vehicle_type', '1'),
(2922, 'Super Admin', 'add_vehicle_type', '1'),
(2923, 'Super Admin', 'update_vehicle_type', '1'),
(2924, 'Super Admin', 'remove_vehicle_type', '1'),
(2925, 'Super Admin', 'view_vehicle_type', '1'),
(2926, 'Super Admin', 'export_vehicle_type', '1'),
(2927, 'Super Admin', 'ambulance_type', '1'),
(2928, 'Super Admin', 'add_ambulance_type', '1'),
(2929, 'Super Admin', 'update_ambulance_type', '1'),
(2930, 'Super Admin', 'remove_ambulance_type', '1'),
(2931, 'Super Admin', 'view_ambulance_type', '1'),
(2932, 'Super Admin', 'export_ambulance_type', '1'),
(2933, 'Super Admin', 'coupon', '1'),
(2934, 'Super Admin', 'add_coupon', '1'),
(2935, 'Super Admin', 'update_coupon', '1'),
(2936, 'Super Admin', 'remove_coupon', '1'),
(2937, 'Super Admin', 'view_coupon', '1'),
(2938, 'Super Admin', 'export_coupon', '1'),
(2939, 'Super Admin', 'transaction', '1'),
(2940, 'Super Admin', 'add_transaction', '1'),
(2941, 'Super Admin', 'update_transaction', '1'),
(2942, 'Super Admin', 'remove_transaction', '1'),
(2943, 'Super Admin', 'view_transaction', '1'),
(2944, 'Super Admin', 'export_transaction', '1'),
(2945, 'Super Admin', 'rating', '1'),
(2946, 'Super Admin', 'add_rating', '1'),
(2947, 'Super Admin', 'update_rating', '1'),
(2948, 'Super Admin', 'remove_rating', '1'),
(2949, 'Super Admin', 'view_rating', '1'),
(2950, 'Super Admin', 'export_rating', '1'),
(2951, 'Super Admin', 'settings', '1'),
(2952, 'Super Admin', 'admin_settings', '1'),
(2953, 'Super Admin', 'state', '1'),
(2954, 'Super Admin', 'district', '1'),
(2955, 'Super Admin', 'bank', '1'),
(2956, 'Super Admin', 'rating_type', '1'),
(2957, 'Super Admin', 'cancellation_reason', '1'),
(2958, 'Super Admin', 'document_type', '1'),
(2959, 'Super Admin', 'vehicle_company', '1'),
(2960, 'Super Admin', 'vehicle_model', '1'),
(2961, 'Super Admin', 'ambulance_model', '1'),
(2962, 'Super Admin', 'ambulance_facility', '1'),
(2963, 'Super Admin', 'fare', '1'),
(2964, 'Super Admin', 'add_fare', '1'),
(2965, 'Super Admin', 'update_fare', '1'),
(2966, 'Super Admin', 'remove_fare', '1'),
(2967, 'Super Admin', 'view_fare', '1'),
(2968, 'Super Admin', 'export_fare', '1'),
(2969, 'Super Admin', 'team_member', '1'),
(2970, 'Super Admin', 'add_team_member', '1'),
(2971, 'Super Admin', 'update_team_member', '1'),
(2972, 'Super Admin', 'remove_team_member', '1'),
(2973, 'Super Admin', 'view_team_member', '1'),
(2974, 'Super Admin', 'export_team_member', '1'),
(2975, 'Super Admin', 'notification', '1'),
(2976, 'Super Admin', 'add_notification', '1'),
(2977, 'Super Admin', 'remove_notification', '1'),
(2978, 'Super Admin', 'view_notification', '1');
...
--
ALTER TABLE `pns_role`
  MODIFY `rid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2979;
