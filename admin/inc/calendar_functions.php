...
function draw_calendar($month,$year){
	...
	/* draw table */
	$calendar = '<table cellspacing="0" cellpadding="0" class="calendar">';
...
{
	global $conn;
	$opOrg = mysqli_query($conn,"SELECT id_event,exname,date FROM ". db_table_pref ."event_details WHERE DATE_FORMAT(date, '%Y-%m-%d')='". $v ."' and exname = ".admin_ID."") or die(mysqli_error($conn));
