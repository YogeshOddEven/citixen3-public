...
{
	global $wn;
	$opOrg = mysqli_query($conn,"SELECT ID,UID,note_date FROM ". db_table_pref ."panel_notes WHERE DATE_FORMAT(note_date, '%Y-%m-%d')='". $v ."' and UID = ".admin_ID."") or die(mysqli_error($conn));
